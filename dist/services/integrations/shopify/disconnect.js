...
async function revokeShopifyAccess(shop, accessToken) {
    try {
...
export default async function disconnectShopify(req, res) {
    ...
    const shop = normalizeShop(typeof rec.externalId === 'string'
        ? rec.externalId
